...
public class JwtTokUtil implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, UserDetails user) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(user.getUsername()).setIssuer("Epam")
                .claim("role",user.getAuthorities()) .setIssuedAt(new Date(System.currentTimeMillis()))
